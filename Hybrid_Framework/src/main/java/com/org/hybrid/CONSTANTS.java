...
public class CONSTANTS {
	...
	public static final String SUITEADATA_XLS = Paths.get(TESTDATAFILES,"/SessionSuite.xlsx").toString();
	public static final String SUITEA_XLS = Paths.get(TESTDATAFILES,"/SuiteA.xlsx").toString();
