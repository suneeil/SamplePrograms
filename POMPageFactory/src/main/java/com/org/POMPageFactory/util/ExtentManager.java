...
public class ExtentManager {
	...
	public static ExtentReports getInstance() {
		if (extent == null) {
			...
			String reportConfigFile = Paths.get(AppConstants.EXTENTREPORT_CONFIG).toString();
			String reportFileLocation = Paths.get(AppConstants.EXTENTREPORT,AppConstants.BROWSER,"report.html").toString();
			//extent = new ExtentReports("D:\\report\\report.html", true, DisplayOrder.OLDEST_FIRST);			
			extent = new ExtentReports(reportFileLocation,true,DisplayOrder.OLDEST_FIRST);
